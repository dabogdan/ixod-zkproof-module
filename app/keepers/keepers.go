...
import (
	...
	// new zkProof
	zkproofkeeper "github.com/ixofoundation/ixo-blockchain/v5/x/zkproof/keeper"
    zkprooftypes "github.com/ixofoundation/ixo-blockchain/v5/x/zkproof/types"
)
...
func NewAppKeepers(
	...
	*/
	...
	// ZkProof
	zkProofKeeper := zkproofkeeper.NewKeeper(appKeepers.keys[zkprooftypes.StoreKey])

	appKeepers.ZkProofKeeper = *zkProofKeeper
